...
namespace Utilities
{
    ...
    {
        [Header("Layer to change")] public LayerMask layerMask;

        [Header("GameObject you want to change layers")]
        public GameObject gameObjectToChange;

        [Header("Change layer based on...")] [Header("Time")]
        ...
        /// <summary>
        ///     Checks if the timer has been reached, and if so, changes the layer of gameObjectToChange to
        ///     layerMask.
        /// </summary>
        private void Update()
        {
            if (useTimer && Time.time > timer) gameObjectToChange.layer = layerMask;
        }

        /// <summary>
        ///     Made a mask field in the editor to more easily select the layer the g.o. will
        ///     change to. The function is called when the object is selected in the editor.
        /// </summary>
        ...
        {
            if (useGameObject && other.gameObject == gameObj) gameObjectToChange.layer = layerMask;
        }
    }
}*/